  ...
  <main class="container">
    ...
    <body>
      ...
      <div class="bg-primary py-4" style="height:50%">
        <p class="text-white display-3 ml-3">XXI CONGRESSO</p>
        <p class="text-white display-3 ml-3">NACIONAL XXXXX</p>

        <div>

          <div class="ml-3">
            <i class="material-icons text-white"> room
            </i>
            <p style="display:inline-block;vertical-align: middle;" class="text-white"> PUC-SP </p>

            <i class="material-icons text-white"> today
            </i>
      ...
      <!-- Sobre o Congresso -->
      <div>
        <H1 class="text-center my-3 display-4">Sobre o Congresso Nacional XXXXXX</H1>
      ...
      <H1 class="text-center my-3 display-4">Informações e datas</H1>
